...
import static com.xtramile.library2024.domain.BookAsserts.*;
...
class BookResourceIT {
    ...
    private static final BookType DEFAULT_TYPE = BookType.HARDCOVER;
    private static final BookType UPDATED_TYPE = BookType.PAPERBACK;
