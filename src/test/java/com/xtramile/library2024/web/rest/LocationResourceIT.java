...
class LocationResourceIT {
    ...
    private static final String DEFAULT_POSTTAL_CODE = "AAAAAAAAAA";
    private static final String UPDATED_POSTTAL_CODE = "BBBBBBBBBB";
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location()
            ...
            .posttalCode(DEFAULT_POSTTAL_CODE)
            .city(DEFAULT_CITY)
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location()
            ...
            .posttalCode(UPDATED_POSTTAL_CODE)
            .city(UPDATED_CITY)
    ...
    void getAllLocations() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.[*].posttalCode").value(hasItem(DEFAULT_POSTTAL_CODE)))
    ...
    void getLocation() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.posttalCode").value(DEFAULT_POSTTAL_CODE))
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.posttalCode(UPDATED_POSTTAL_CODE).city(UPDATED_CITY);
