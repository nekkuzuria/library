...
import { sampleWithRequiredData } from '../book-storage.test-samples';
...
describe('BookStorage Management Component', () => {
  let comp: BookStorageComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(BookStorageComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.bookStorages?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to bookStorageService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getBookStorageIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getBookStorageIdentifier).toHaveBeenCalledWith(entity);
