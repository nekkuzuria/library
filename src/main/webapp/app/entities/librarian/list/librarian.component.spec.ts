...
import { sampleWithRequiredData } from '../librarian.test-samples';
...
describe('Librarian Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to librarianService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getLibrarianIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getLibrarianIdentifier).toHaveBeenCalledWith(entity);
