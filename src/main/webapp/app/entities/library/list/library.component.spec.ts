...
import { sampleWithRequiredData } from '../library.test-samples';
...
describe('Library Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to libraryService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getLibraryIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getLibraryIdentifier).toHaveBeenCalledWith(entity);
