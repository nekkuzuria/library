...
public class BookResource {
    ...
    public ResponseEntity<List<BookDTO>> getAllBooks(
        ...
        if ("visitorbookstorage-is-null".equals(filter)) {
            log.debug("REST request to get all Books where visitorBookStorage is null");
            return new ResponseEntity<>(bookService.findAllWhereVisitorBookStorageIsNull(), HttpStatus.OK);
        }
